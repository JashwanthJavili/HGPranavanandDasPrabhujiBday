      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl border-t-4 border-saffron-400 hover:shadow-2xl transition-shadow duration-300">
                <div className="absolute inset-0 bg-cover" style={{ backgroundImage: `url('/Images/Radhanath Swamy Maharaj.jpg')`, backgroundPosition: 'center 35%' }} />
                <div className="absolute inset-0 bg-black/60" />
                <div className="p-8 md:p-10 relative z-10">
                <div className="flex items-center space-x-4 mb-6">
                    <div className="h-16 w-16 rounded-full overflow-hidden border-2 border-saffron-200">
                         <img src="/Images/Radhanath Swamy Maharaj.jpg" alt="HH Radhanath Swami" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl border-t-4 border-orange-400 hover:shadow-2xl transition-shadow duration-300">
               <div className="absolute inset-0 bg-cover" style={{ backgroundImage: `url('/Images/HG Pranavanand Das Prabhu1ji.jpg')`, backgroundPosition: 'center 40%' }} />
                <div className="absolute inset-0 bg-black/60" />
                <div className="p-8 md:p-10 relative z-10">
                <div className="flex items-center space-x-4 mb-6">
                    <div className="h-16 w-16 rounded-full overflow-hidden border-2 border-orange-200">
                         <img src="/Images/HG Pranavanand Das Prabhu1ji.jpg" alt="HG Pranavananda Das" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                     <div>
